...
<p>To delete a Test or Survey, choose it from the Test/Survey Manager and use the <code>Delete</code> button.  Aftering confirming the delete action, the test will be removed.  Note that the questions within the test will not be deleted as they are stored in the <a href="question_database.php">Question Bank</a>. </p>
