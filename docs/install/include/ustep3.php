...
<?php if (version_compare($_POST['step1']['old_version'], '1.5', '<')): ?>
	...
	<br />
		...
		<tr>
			<td class="row1"><b><label for="username">Administrator Username:</label></b><br />
		...
		<tr>
			<td class="row1"><b><label for="password">Password:</label></b></td>
		...
		<tr>
			<td class="row1"><b><label for="email">Email:</label></b></td>
		...
		<tr>
			<td class="row1"><b><label for="cemail">Contact Email:</label></b><br />
