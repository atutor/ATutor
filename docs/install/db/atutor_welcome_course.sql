...
INSERT INTO `courses` VALUES (0, 1, 0, 'top', 'public', NOW(), 'Welcome Course', '', 0, '-2', '-3', 0, '', '', '', '', '', '', 'off');
...
# create example test
INSERT INTO `tests` VALUES ('1', '1', 'About ATutor Test', '0', NOW(), '2005-12-30 12:00:00', '1', '0', 'This is an example test.', 0, 0, 0, 0);
