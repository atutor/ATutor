...
INSERT INTO `courses` VALUES (1, 1, 0, 'top', 'public', NOW(), 'Welcome Course', '', 0, '-2', '-3', 0, '', '', '', '', '', '', 'en', 0, '', 'forum/list.php|glossary/index.php|discussions/achat/index.php|tile.php|links/index.php|tools/my_tests.php|sitemap.php|export.php|my_stats.php|polls/index.php|directory.php|inbox/index.php','forum/list.php|glossary/index.php','menu_menu|related_topics|users_online|glossary|search|poll|posts');
