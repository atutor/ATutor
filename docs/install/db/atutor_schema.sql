...
INSERT INTO `themes` VALUES ('ATutor', '2.0', 'default', NOW(), 'This is the default ATutor theme and cannot be deleted as other themes inherit from it. Please do not alter this theme directly as it would complicate upgrading. Instead, create a new theme derived from this one.', 2);
INSERT INTO `themes` VALUES ('Fluid', '2.0', 'fluid', NOW(), 'Theme that implements the Fluid reorderer used to drag-and-drop the menu from side-to-side.', 1);
INSERT INTO `themes` VALUES ('ATutor Classic', '2.0', 'default_classic', NOW(), 'This is the ATutor Classic theme which makes use of the custom Header and logo images. To customize those images you must edit the <code>theme.cfg.php</code> in this themes directory.', 1);
INSERT INTO `themes` VALUES ('Blumin', '2.0', 'blumin', NOW(), 'This is the plone look-alike theme.', 1);
INSERT INTO `themes` VALUES ('Greenmin', '2.0', 'greenmin', NOW(), 'This is the plone look-alike theme in green.', 1);
INSERT INTO `themes` VALUES ('ATutor 1.5', '2.0', 'default15', NOW(), 'This is the 1.5 series default theme.', 1);
INSERT INTO `themes` VALUES ('ATutor 1.6', '2.0', 'default16', NOW(), 'This is the 1.6 series default theme.', 1);
INSERT INTO `themes` VALUES ('Mobile', '2.0', 'mobile', NOW(), 'This is the default theme for mobile devices.', 1);
