...
[<a href="users/admin/course_categories.php"><?php echo _AT('cats_course_categories');?></a>]
<br /><br />
...
<?php
	do {
		...
		echo '<td class="row1"><small><a href="users/admin/course.php?course='.$row['course_id'].'"><b>'.$row['title'].'</b></a></small>';
