...
/****************************************************************/
	...
	print_help($help);
		...
		<tr>
			<th colspan="2" class="cat"><small><?php print_popup_help(AT_HELP_PRESET); ?></small><?php echo _AT('preset_preferences')?></th>
		</tr>
		<tr>
	...
	<tr>
		...
		<tr>
			<th colspan="2" class="cat"><small><?php print_popup_help(AT_HELP_POSITION_OPTIONS); ?></small>
			<?php echo _AT('pos_options')?></th>
		</tr>
		<tr>
		...
		<tr>
			<th colspan="2" class="cat"><small><?php print_popup_help(AT_HELP_DISPLAY_OPTIONS); ?></small><?php echo _AT('disp_options');  ?></th>
		</tr>
		<tr>
			<td class="row1"><?php
	...
	<tr>
		<td valign="top"><table border="0" width="100%" class="bodyline" cellspacing="1" cellpadding="0">
		<tr>
			<th colspan="2" class="cat"><small><?php print_popup_help(AT_HELP_TEXTICON_OPTIONS); ?></small><?php echo _AT('text_and_icons');  ?></th>
		</tr>
		<tr>
		...
		<td valign="top" width="50%"><table border="0"  width="100%" class="bodyline" cellspacing="1" cellpadding="0">
			<tr>
				<th colspan="2" class="cat"><small><?php print_popup_help(AT_HELP_MENU_OPTIONS); ?></small><?php  echo _AT('menus'); ?></th>
			</tr>
			<tr>
