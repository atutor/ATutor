...
if (admin_authenticate(AT_ADMIN_PRIV_USERS, TRUE) || admin_authenticate(AT_ADMIN_PRIV_ADMIN, TRUE)) {
	...
	$this->_pages['admin/users.php']['guide']     = 'admin/?p=3.0.users.php';
	$this->_pages['admin/users.php']['children']  = array('admin/create_user.php', 'admin/default_preferences.php', 'admin/instructor_requests.php', 'admin/master_list.php', 'admin/admin_email.php', 'admin/admins/index.php');

		$this->_pages['admin/admin_email.php']['title_var'] = 'admin_email';
		$this->_pages['admin/admin_email.php']['parent']    = 'admin/users.php';
		$this->_pages['admin/admin_email.php']['guide']     = 'admin/?p=3.3.email_users.php';
		...
		$this->_pages['admin/instructor_requests.php']['guide']     = 'admin/?p=3.1.instructor_requests.php';
		...
		$this->_pages['admin/master_list.php']['guide']     = 'admin/?p=3.2.master_student_list.php';
		...
		$this->_pages['admin/admins/index.php']['guide']     = 'admin/?p=3.4.administrators.php';
