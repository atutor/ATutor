...
if (admin_authenticate(AT_ADMIN_PRIV_USERS, TRUE) || admin_authenticate(AT_ADMIN_PRIV_ADMIN, TRUE)) {
	...
	$this->_pages['mods/_core/users/users.php']['guide']     = 'mods/_core/users/?p=users.php';
	...
	if (admin_authenticate(AT_ADMIN_PRIV_ADMIN, TRUE)) {
		...
		$this->_pages['mods/_core/users/admins/index.php']['guide']     = 'mods/_core/users/?p=administrators.php';
		...
		$this->_pages['mods/_core/users/admin_email.php']['guide']     = 'mods/_core/users/?p=email_users.php';
		...
		$this->_pages['mods/_core/users/default_preferences.php']['guide']     = 'mods/_core/users/?p=default_preferences.php';
		...
		$this->_pages['mods/_core/users/instructor_requests.php']['guide']     = 'mods/_core/users/?p=instructor_requests.php';
		...
		$this->_pages['mods/_core/users/master_list.php']['guide']     = 'mods/_core/users/?p=master_student_list.php';
