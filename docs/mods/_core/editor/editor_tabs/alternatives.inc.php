...
require(AT_INCLUDE_PATH.'../mods/_core/editor/editor_tabs/alternatives_functions.inc.php');
...
<?php 
	require(AT_INCLUDE_PATH.'../mods/_core/file_manager/filemanager_display_alternatives.inc.php');
?>
	  </div>
	</div>
