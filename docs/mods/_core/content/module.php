...
$this->_pages['tools/content/index.php']['children']  = array('editor/add_content.php', 'editor/arrange_content.php', 'tools/ims/index.php');
...
$this->_pages['editor/arrange_content.php']['title_var']    = 'arrange_content';
$this->_pages['editor/arrange_content.php']['parent']   = 'tools/content/index.php';
$this->_pages['editor/arrange_content.php']['guide']     = 'instructor/?p=arrange_content.php';
