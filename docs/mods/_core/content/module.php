...
$this->_pages['tools/content/index.php']['guide']     = 'instructor/?p=4.0.content.php';
$this->_pages['tools/content/index.php']['children']  = array('editor/add_content.php', 'tools/ims/index.php');
	...
	$this->_pages['editor/add_content.php']['guide']     = 'instructor/?p=4.1.creating_editing_content.php';
	...
	$this->_pages['editor/edit_content.php']['guide']     = 'instructor/?p=4.1.creating_editing_content.php';
