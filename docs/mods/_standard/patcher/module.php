...
$this->_pages['mods/_standard/patcher/index_admin.php']['guide']     = 'admin/?p=patcher.php';
$this->_pages['mods/_standard/patcher/patch_create.php']['guide']     = 'admin/?p=create_patches.php';
