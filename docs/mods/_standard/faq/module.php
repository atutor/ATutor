...
$_module_pages['mods/_standard/faq/index_instructor.php']['children']  = array('mods/faq/add_topic.php', 'mods/faq/add_question.php');

	$_module_pages['mods/_standard/faq/add_topic.php']['title_var'] = 'add_topic';
	$_module_pages['mods/_standard/faq/add_topic.php']['parent']    = 'mods/faq/index_instructor.php';

	$_module_pages['mods/_standard/faq/add_question.php']['title_var'] = 'add_question';
	$_module_pages['mods/_standard/faq/add_question.php']['parent']    = 'mods/faq/index_instructor.php';

	$_module_pages['mods/_standard/faq/delete_question.php']['title_var'] = 'delete_question';
	$_module_pages['mods/_standard/faq/delete_question.php']['parent']    = 'mods/faq/index_instructor.php';

	$_module_pages['mods/_standard/faq/edit_question.php']['title_var'] = 'edit_question';
	$_module_pages['mods/_standard/faq/edit_question.php']['parent']    = 'mods/faq/index_instructor.php';
