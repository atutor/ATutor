...
INSERT INTO `language_text` VALUES ('en', '_module','pa_upload_blurb','Click "Browse" to look for the picture you wish to upload.  These photos will be processed and display below.  You also have the option to remove the pending photos anytime.  When you are done, click "Upload".',NOW(),'');
