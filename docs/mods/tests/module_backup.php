...
function tests_convert($row, $course_id, $member_id, $table_id_map) {
	$new_row = array();
	$new_row[0]  = $row[0];
	$new_row[1]  = $course_id;
	$new_row[2]  = $row[1];
...
function tests_questions_categories_convert($row, $course_id, $member_id, $table_id_map) {
	$new_row = array();
	$new_row[0] = $row[0];
	$new_row[1] = $course_id;
	$new_row[2] = $row[1];
...
function tests_questions_convert($row, $course_id, $member_id, $table_id_map) {
	$new_row = array();
	$new_row[0]  = $row[0];
...
function tests_questions_assoc_convert($row, $course_id, $member_id, $table_id_map) {
	$new_row = array();
