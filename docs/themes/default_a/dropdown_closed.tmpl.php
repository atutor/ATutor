...
<div class="dropdown">
	...
	<img src="<?php echo $this->tmpl_base_path; ?>themes/<?php echo $this->tmpl_theme; ?>/images/twisty.gif"  align="middle"  class="twisty1" title="<?php echo _AT('closed ')?>" alt="<?php echo _AT('closed ')?>" />
