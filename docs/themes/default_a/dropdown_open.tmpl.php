...
<div class="dropdown">
	...
	<div class="dropdown-heading">
		<img src="<?php echo $this->tmpl_base_path; ?>themes/<?php echo $this->tmpl_theme; ?>/images/twisty-dn.gif"  align="middle"  class="twisty2" title="<?php echo _AT('opened ')?>" alt="<?php echo _AT('opened ')?>"/>
