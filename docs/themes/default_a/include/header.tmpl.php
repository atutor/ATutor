...
/************************************************************************/
// $Id: header.tmpl.php 3681 2005-03-04 17:23:55Z joel $
...
<body <?php echo $this->tmpl_onload; ?> style="background-image: url('<?php echo $this->tmpl_base_path . HEADER_IMAGE; ?>'); "  nowrap="nowrap"><div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div><script language="JavaScript" src="<?php echo $this->tmpl_base_path; ?>overlib.js" type="text/javascript"></script><a href="<?php echo $_SERVER['REQUEST_URI']; ?>#content"><img src="<?php echo $this->tmpl_base_path; ?>images/clr.gif" height="1" width="1" border="0" alt="<?php echo _AT('goto_content'); ?>" /></a>
	...
	<?php if ($this->sequence_links): ?>
		<div id="sequence-links">
			<?php if ($this->sequence_links['resume']): ?>
				<a href="<?php echo $this->sequence_links['resume']['url']; ?>"><img src="<?php echo $this->tmpl_base_path.'themes/'.$this->tmpl_theme; ?>/images/continue.gif" border="0" align="middle" /> <?php echo $this->sequence_links['resume']['title']; ?></a>
			<?php else: ?>
				<?php if ($this->sequence_links['previous'] && $this->sequence_links['next']): ?>
					<a href="<?php echo $this->sequence_links['previous']['url']; ?>"><img src="<?php echo $this->tmpl_base_path.'themes/'.$this->tmpl_theme; ?>/images/previous.gif" border="0" align="middle"  title="<?php echo $this->sequence_links['previous']['title']; ?>"/> </a>
					|
					<a href="<?php echo $this->sequence_links['next']['url']; ?>"><img src="<?php echo $this->tmpl_base_path.'themes/'.$this->tmpl_theme; ?>/images/next.gif" border="0" align="middle" title=" <?php echo $this->sequence_links['next']['title']; ?>" /></a>
				<?php elseif ($this->sequence_links['previous']): ?>
					<a href="<?php echo $this->sequence_links['previous']['url']; ?>"><img src="<?php echo $this->tmpl_base_path.'themes/'.$this->tmpl_theme; ?>/images/previous.gif" border="0" align="middle" /> <?php echo $this->sequence_links['previous']['title']; ?></a>
				<?php elseif ($this->sequence_links['next']): ?>
					<a href="<?php echo $this->sequence_links['next']['url']; ?>"><?php echo $this->sequence_links['next']['title']; ?> <img src="<?php echo $this->tmpl_base_path.'themes/'.$this->tmpl_theme; ?>/images/continue.gif" border="0" align="middle" /></a>
				<?php endif; ?>
			<?php endif; ?>
		</div>
	<?php endif; ?>
