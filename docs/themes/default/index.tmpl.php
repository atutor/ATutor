...
if($this->view_mode==0){ ?>
	<div style="width: 90%; margin-top: -5px; float:left;">
		<ul id="home-links">
		<br/>
				...
				if($num_modules!=0){													//si controlla se sono presenti moduli visibili nella home.
					if($num_modules != 1 && $link['check'] == 'visible'){ 				//se check � impostato 'visible' significa che il modulo sar� presente nella home e potrebbe necessitare delle frecce direzionali
						if($count_modules <= 2 ){ 
							...
							if($column=="left")
								echo '<a href ="'.AT_BASE_HREF.'move_module.php?mid='.$count_modules.'&amp;move=right"><img src="'.AT_BASE_HREF.'images/arrow-mini-right.png" alt="move right" border="0"/></a>&nbsp;';
							else 
