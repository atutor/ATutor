...
<tr class="header-bg">
	<td align="left"><?php echo $this->tmpl_bypass_links; ?>
		<?php if (HEADER_LOGO): ?>
			&nbsp;<img src="<?php echo $this->tmpl_base_path.HEADER_LOGO; ?>" class="img" border="0" alt="<?php echo SITE_NAME; ?>" />&nbsp;
		<?php endif; ?>
			...
			<?php foreach ($this->tmpl_user_nav as $page => $link): ?>
				<?php if ($page == 'jump_menu'): ?>
					...
					<?php else: ?>
						> 
					<?php endif; ?>
					<form method="post" action="<?php echo $this->tmpl_base_path; ?>bounce.php?p=<?php echo urlencode($this->tmpl_rel_url); ?>" target="_top"><label for="jumpmenu" accesskey="j"></label>
