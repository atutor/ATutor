		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>			
				...
				<?php foreach ($tmpl_course_nav as $page => $link): ?>
					<!-- regular menu item -->					
					<?php if ($tmpl_page == $page): ?>
						<td valign="top" nowrap="nowrap" class="course-nav-item selected">
					<?php else: ?>
...
<table cellpadding="0" cellspacing="0">
	<tr>
		<td><img src="../../images/orange_left.gif" alt="LEFT" /></td>
		<td bgcolor="white"><a href="<?php echo $link['url']; ?>" <?php echo $link['attribs']; ?> title="<?php echo $link['title']; ?>" ><?php echo $link['name'] ?></a></td>
		<td><img src="../../images/orange_right.gif" alt="LEFT" /></td>
	</tr>
</table>
