...
<script type="text/javascript" defer="defer"><!--
	...
	function initEditor() {
		...
		config.registerButton("my-filemanager", "Import file", _editor_url+"images/myfilemanager.gif", false, myfilemanager);
		...
		config.toolbar = [
			...
			["insertorderedlist", "insertunorderedlist", "outdent", "indent", "separator", "inserthorizontalrule", "createlink", "insertimage", "inserttable", "htmlmode", "separator", "undo", "redo", "separator", "popupeditor", "separator", "about", "space", "space", "separator", "separator", "space", "space", "my-glossary", "separator", "my-filemanager"]
			];
	...
	function myfilemanager(editor, id) {
		var outparam = null;
		var link;
		...
		editor._popupDialog("my_filemanager.php", function(param) {
			if (!param)
				return false;
			var a = link;
			if (!a) {
			...
			else {   //overwrites an exsiting link
