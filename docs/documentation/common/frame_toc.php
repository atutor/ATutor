...
<ul>
	...
	<li><a href="1.0.installation.php" class="tree" id="1.0.installation.php">Installation</a>
		<ul>
			<li><a href="1.1.requirements_recommendations.php" class="leaf" id="1.1.requirements_recommendations.php">Requirements &amp; Recommendations</a></li>
			<li><a href="1.2.new_installation.php" class="leaf" id="1.2.new_installation.php">New Installation</a></li>
			<li><a href="1.3.upgrading.php" class="leaf" id="1.3.upgrading.php">Upgrading an Installation</a></li>
		</ul>
	</li>
		<li><a href="2.0.configuration.php" class="tree" id="2.0.configuration.php">Configuration</a>
		<ul>
			<li><a href="2.1.my_account.php" class="leaf" id="2.1.my_account.php">My Account</a></li>
			<li><a href="2.2.system_preferences.php" class="leaf" id="2.2.system_preferences.php">System Preferences</a></li>
			<li><a href="2.3.languages.php" class="tree" id="2.3.languages.php">Languages</a>
				<ul>
					<li><a href="2.3.1.importing_languages.php" class="leaf" id="2.3.1.importing_languages.php">Importing Languages</a></li>
					<li><a href="2.3.2.managing_existing_languages.php" class="leaf" id="2.3.2.managing_existing_languages.php">Managing Existing Languages</a></li>
					<li><a href="2.3.3.translating_atutor.php" class="leaf" id="2.3.3.translating_atutor.php">Translating ATutor</a></li>
				</ul>
				</li>
			<li><a href="2.4.themes.php" class="tree" id="2.4.themes.php">Themes</a>
				<ul>
					<li><a href="2.4.1.importing_themes.php" class="leaf" id="2.4.1.importing_themes.php">Importing Themes</a></li>
					<li><a href="2.4.2.managing_existing_themes.php" class="leaf" id="2.4.2.managing_existing_themes.php">Managing Existing Themes</a></li>
					<li><a href="2.4.3.creating_themes.php" class="leaf" id="2.4.3.creating_themes.php">Creating Themes</a></li>
				</ul>
			</li>
			<li><a href="2.5.error_logging.php" class="leaf" id="2.5.error_logging.php">Error Logging</a></li>
		</ul>
	</li>

	<li><a href="3.0.users.php" class="tree" id="3.0.users.php">Users</a>
		<ul>
			<li><a href="3.1.instructor_requests.php" class="leaf" id="3.1.instructor_requests.php">Instructor Requests</a></li>
			<li><a href="3.2.master_student_list.php" class="tree" id="3.2.master_student_list.php">Master Student List</a>
				<ul>
					<li><a href="3.2.1.importing_student_ids.php" class="leaf" id="3.2.1.importing_student_ids.php">Importing Student IDs</a></li>
				</ul>
				</li>
			<li><a href="3.3.email_users.php" class="leaf" id="3.3.email_users.php">Email Users</a></li>
			<li><a href="3.4.administrators.php" class="tree" id="3.4.administrators.php">Administrators</a>
				<ul>
					<li><a href="3.4.1.administrator_activity_log.php" class="leaf" id="3.4.1.administrator_activity_log.php">Administrator Activity Log</a></li>
				</ul>
			</li>
		</ul>
	</li>

	<li><a href="4.0.courses.php" class="tree" id="4.0.courses.php">Courses</a>
		<ul>
			<li><a href="4.1.backups.php" class="tree" id="4.1.backups.php">Backups</a>
				<ul>
					<li><a href="4.1.1.creating_backups.php" class="leaf" id="4.1.1.creating_backups.php">Creating Backups</a></li>
					<li><a href="4.1.2.restoring_backups.php" class="leaf" id="4.1.2.restoring_backups.php">Restoring Backups</a></li>
				</ul>
			</li>
			<li><a href="4.2.forums.php" class="leaf" id="4.2.forums.php">Forums</a></li>
			<li><a href="4.3.categories.php" class="leaf" id="4.3.categories.php">Categories</a></li>
		</ul>
	</li>
