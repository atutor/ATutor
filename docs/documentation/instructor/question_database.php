...
<h2>Question Database</h2>
	...
	<dl>
		<dt>Import Question</dt>
		<dd>Individual questions, or collections of questions that are not yet part of a test, can be imported from IMS QTI 1.2 packages using the Import Questions feature at the top of the Question Database. Also see <a href="tests_surveys.php">Tests &amp; Surveys</a> for details on importing complete tests. </dd>
