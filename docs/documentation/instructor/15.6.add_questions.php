...
<p>To manage the questions in a test, choose the test from the Test/Surveys Manager and then use the <code>Questions</code> button. Questions in the <a href="15.2.question_database.php">Question Database</a> can be added to your test by using the <em>Add Questions</em> link. Check the questions and/or categories of questions to be added to the test and use the <code>Add to Test/Survey</code> button. After confirming this action, the added questions will appear in the Question Manager.  Beside each question is a box in which to enter a weight or mark for that question.  If this is for a survey, leave the weight box empty.</p>
