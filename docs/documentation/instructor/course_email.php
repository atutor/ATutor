...
<ul>
<li><strong>{AT_FNAME}</strong> Replaced with recipient's first name.</li>
<li><strong>{AT_LNAME}</strong> Replaced with recipient's last name.</li>
<li><strong>{AT_EMAIL}</strong> Replaced with recipient's email.</li>
<li><strong>{AT_USER}</strong>  Replaced with recipient's login name.</li>
<li><strong>{AT_PASSWORD}</strong>  Replaced with recipient's password.</li>
</ul>
