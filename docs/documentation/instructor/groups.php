...
<h2>Groups</h2>
	...
	<h3>Create a single group manually</h3>
		...
		<p>Enter the type of project, title, and description. Also choose which tools be made avialable to this groups (File Storage, Forums, Blog, etc.) and use the <code>Create</code> button.</p>
