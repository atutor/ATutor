...
<h2>2.1 Creating &amp; Restoring Backups</h2>
	...
	<p>Backups can restored by selecting the backup and using the <kbd>Restore</kbd> button. The restoration process will presents details on what is stored in the backup and provides with the ability to restore any or all of the available material.</p>
