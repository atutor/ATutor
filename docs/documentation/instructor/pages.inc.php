...
// $Id$
    ...
    $_pages['privileges.php']					 = 'Privileges';
    $_pages['alumni.php']                        = 'Alumni';
    $_pages['groups.php']                        = 'Groups';
    $_pages['course_list.php']                   = 'Course Lists';
    $_pages['file_manager.php']                  = 'File Manager';
    $_pages['creating_folders.php']              = 'Creating Folders';
    $_pages['uploading_files.php']               = 'Uploading Files';
    $_pages['creating_new_files.php']            = 'Creating New Files';
    $_pages['editing_files.php']                 = 'Editing Files';
    $_pages['previewing_files.php']              = 'Previewing Files';
    ...
    $_pages['creating_forums.php']               = 'Creating Forums';
    $_pages['editing_forums.php']                = 'Editing Forums';
    $_pages['shared_forums.php']                 = 'Shared Forums';
    ...
    $_pages['link_categories.php']               = 'Link Categories';
    ...
    $_pages['statistics.php']					 = 'Test Statistics';
