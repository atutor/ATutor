...
<h2>15.1 Creating a Test or Survey</h2>
	...
	<dl>
		...
		<dd>Specifies the groups (as defined in the <a href="6.0.enrollment.php">Enrollment Manager</a>) permitted to take this test. By default, tests are available to Everyone in the course.</dd>
	</dl>
