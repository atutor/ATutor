...
<dl>
    <dt>Theme</dt>
    <dd>Themes are used for changing the look and feel - only themes installed by the administrator are available.</dd>
    ...
    <dd>If enabled, ordered numbers will prefix topic titles.</dd>
    ...
    <dt>Auto-Login</dt>
    <dd>If enabled, manual login is no longer required as the user will be automatically logged in.</dd>
