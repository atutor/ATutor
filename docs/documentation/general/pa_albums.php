...
<h3>Search</h3>
<p>The search tab are shown on the top left on each Album page(Except Profile Album).  Users can type in any text to search for the relevant albums and photos.  The search will return matches found in the photo album's description, location; and photo's description, alternative text. </p>
