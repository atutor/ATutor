...
<p>There are four types of user accounts that can exist in an ATutor installation, as defined by their Status:	
	<dl>
		...
		<dt>Unconfirmed</dt>
		<dd>Unconfirmed accounts are created only when the <a href="../admin/2.2.system_preferences.php">System Preferences</a> <em>Require Email Confirmation Upon Registration</em> option is enabled.</dd>
		<dt>Student</dt>
