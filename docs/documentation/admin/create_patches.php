...
<dl>
	...
	<dd>This needs to be the exact version number of the ATutor version the patch applies to (e.g 1.6). including any minor version numbers (e.g 1.6.1.2)  The exact version number can be found on the Administrator open screen under "Statistics and Information"
	</dd>
	<dt>Description</dt>
	...
	<dd>It is common for later patches to require changes from earlier patches before they can be installed. If this is the case for the patch you are creating, enter the patch IDs in a comma separated list (e.g. 0003, 0005, uoft_0001). Be sure to check the patches on the opening screen of the Patcher to see if the file you are modifying with your patch is  being modified by an update.atutor.ca patch. If they are modifying the same files, you may need to include the ID numbers for those patches in the Dependant Patches for the patch your are creating.</dd>
	<dt>Files</dt>	
