...
require('../common/body_header.inc.php'); ?>
	...
	<a name="4"></a><h2>2.4 Themes</h2>
		<p>Themes are used for changing the look and feel of an ATutor installation. Themes can be set as a personal preference or forced to display by default using the <a href="../admin/2.2.system_preferences.php">System Preferences</a> <em>Theme Specific Categories</em> option.</p>
