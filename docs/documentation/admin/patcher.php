...
<dl>
	...
	<dd>On the opening screen of the Patcher will appear a list of patches available for the version of ATutor you are using, along with a description of each patch.  This list is retrieved from update.atutor.ca, as are the patches themselves, so you must be connected to the Internet. Patches are retreived from update.atutor.ca in a zip form, unzipped by ATutor and applied as necessary. </dd>
	<dt>File Permissions</dt>
	<dd>In most cases you will be asked to temporarliy grant write permission to the files that need to be updated or replaced, then once the patch has been applied, you will be asked to change the permissions back to read only. It is important that you follow the instructions after patches have been applied, otherwise you run the risk of opening a security hole. 
	</dd>
	<dt>Types of Patches</dt>
	<dd>Patches come in various forms. Some patches replace code in a file with new code. Others replace a file with a new file.  Others may do both on mutliple files and mutliple code changes. Other patches delete files that are no longer required.</dd>
