...
<h3>Creating Backups</h3>
	<p>To create a backup, use the <em>Create Backup</em> link in the sub-navigation. The number of backups a single course can keep on the server is defined by the <a href="../admin/2.2.system_preferences.php">System Preferences</a> <em>Course Backups</em> option.</p>
