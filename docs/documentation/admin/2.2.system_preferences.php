...
require('../common/body_header.inc.php'); ?>
	...
	<h2>2.2 System Preferences</h2>
		...
		<dl>
			...
			<dd><p>Where cached data is stored. On a Windows machine the path should look like <kbd>C:\Windows\temp\</kbd>, while on Unix it should look like <kbd>/tmp/cache/</kbd>. On newer Linux/Unix based system shared memory device can also be used <kbd>/dev/shm/</kbd> if it is available.  Leave empty to disable caching.</p></dd>
