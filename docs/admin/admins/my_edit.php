...
<div class="input-form">
	<div class="row">
		<label for="password"><span class="required">*</span><?php echo _AT('password'); ?></label><br />
		<input type="password" name="password" id="password" size="25" value="<?php echo $_POST['password']; ?>" />
	</div>

	<div class="row">
		<label for="password2"><span class="required">*</span><?php echo _AT('confirm_password'); ?></label><br />
	...
	<div class="row">
		<label for="email"><span class="required">*</span><?php echo _AT('email'); ?></label><br />
