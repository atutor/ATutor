...
<div class="input-form">
	...
	<div class="row">
		...
		<input type="checkbox" name="priv_admin" value="1" id="priv_admin" /><label for="priv_admin"><?php echo _AT('priv_admin'); ?></label><br /><br />

		<input type="checkbox" name="priv_users" value="1" id="priv_users" /><label for="priv_users"><?php echo _AT('priv_users'); ?></label><br />
		<input type="checkbox" name="priv_courses" value="1" id="priv_courses" /><label for="priv_courses"><?php echo _AT('priv_courses'); ?></label><br />
		<input type="checkbox" name="priv_backups" value="1" id="priv_backups" /><label for="priv_backups"><?php echo _AT('priv_backups'); ?></label><br />
		<input type="checkbox" name="priv_forums" value="1" id="priv_forums" /><label for="priv_forums"><?php echo _AT('priv_forums'); ?></label><br />
		<input type="checkbox" name="priv_categories" value="1" id="priv_categories" /><label for="priv_categories"><?php echo _AT('priv_categories'); ?></label><br />
		<input type="checkbox" name="priv_languages" value="1" id="priv_languages" /><label for="priv_languages"><?php echo _AT('priv_languages'); ?></label><br />
		<input type="checkbox" name="priv_themes" value="1" id="priv_themes" /><label for="priv_themes"><?php echo _AT('priv_themes'); ?></label>
	</div>
