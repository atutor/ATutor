...
if (isset($_POST['view'])) {
	...
	echo '<br/><h3>' . _AT('view_log_file') . ' profile: ' . $key . '</h3>';
	?>
	...
	<table cellspacing="1" cellpadding="0" border="0" class="bodyline" width="95%" summary="" align="center">
		<tr>
			<th class="cat"><?php echo 'Bug Identifier'; ?></th>
			<th class="cat"><?php echo 'Timestamp'; ?></th>
		</tr>
	...
	<?php
		...
		<tr>
			<td class="row1" align="center" colspan="2">
				<br /><input type="submit" name="view" value="<?php echo 'View Bugs'; ?>" class="button" /> -
