...
if (isset($_POST['submit_no']))
{
	...
	if ($_POST['permission_granted']==1)
		header('Location: '.AT_BASE_HREF.'admin/modules/module_install_step_3.php?cancelled=1');
	else
	{
...
else if (isset($_POST['submit_yes'])) 
{
	...
	else 
	{
		if ($_POST['permission_granted']==1)
		{
			header('Location: '.AT_BASE_HREF.'admin/modules/module_install_step_3.php?installed=1');
		}
		else
		{
