...
?>
		...
		<tr><td colspan="2" valign="top" align="left" class="row1">
			...
			(<input type="checkbox" onclick="javascript: myFunction(); document.form.formatting.html.checked='true';" value="1" name="visual" id="visual" <?php if ($_POST['visual']){ echo 'checked="checked"';} if (!$_POST['formatting']){ echo 'disabled="disabled"';} ?> /><label for="visual"><?php echo _AT('enable visual'); ?></label>)
