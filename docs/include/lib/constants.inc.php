...
$_config_defaults['home_defaults']             = 'forum/list.php|glossary/index.php|chat/index.php|tile.php|mods/_standard/faq/index.php|links/index.php|tools/my_tests.php|sitemap.php|export.php|my_stats.php|polls/index.php|directory.php';
