...
$_modules = array('sitemap.php', 'export.php', 'chat/index.php', 'tile.php', 'my_stats.php', 'forum/list.php' ,'acollab/bounce.php', 'directory.php');
...
/* module statuses */
define('AT_MOD_DISABLED',		0); // was 0
define('AT_MOD_ENABLED',	    1); // was 1
