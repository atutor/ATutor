...
/************************************************************************/
// $Id: course_footer.tmpl.php,v 1.1 2004/04/15 19:24:35 heidi Exp $
...
global $_stacks;
	...
	<div align="right" id="top">
		...
		<?php if ($tmpl_show_imgs): ?>
			<a href="<?php echo $tmpl_my_uri; ?>g=6#content" title="<?php _AT('back_to_top'); ?> ALT-c"><img src="<?php $tmpl_base_path; ?>images/top.gif" alt="<?php _AT('back_to_top'); ?>" border="0" class="menuimage4" height="25" width="28"  /></a><br />
		<?php endif; ?>
