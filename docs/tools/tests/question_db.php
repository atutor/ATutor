...
<div class="input-form" width="90%">
	<fieldset class="group_form" style="width:45%;float:right;height:18em;"><legend class="group_form"><?php echo _AT('import_question'); ?></legend>
	...
	<fieldset class="group_form" style="width:45%;"><legend class="group_form"><?php echo _AT('create_new_question'); ?></legend>
