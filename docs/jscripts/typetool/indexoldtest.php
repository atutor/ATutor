...
define('AT_INCLUDE_PATH', '../../include/');
	...
	//require(AT_INCLUDE_PATH.'headertest.inc.php');
?>
<HTML>
<HEAD>
<title>Readme</title>
...
<TD><TEXTAREA name=textarea1 rows=10 cols=50>Please click and then "OK".
</TEXTAREA></TD></TR>
<TR>
<TD align=right>Textarea 2: </TD>
<TD><TEXTAREA name=textarea2 rows=10 cols=50>Please click and then "CANCEL" and then "right mousebutton".</TEXTAREA></TD></TR>
<TR>
...
<BR ><strong>GPL-Copyright</strong>
</body>

<?php
	//require (AT_INCLUDE_PATH.'footertest.inc.php');
?>
