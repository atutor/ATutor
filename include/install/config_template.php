 ...
 * @param string  $filename    path to the config file, relative to the
 *                             currently running script
 * @param string  $db_login    self-explanatory
 * @param string  $db_pwd      url-encoded password for mysql account
 * @param string  $db_host     self-explanatory
 * @param string  $db_port     self-explanatory
 * @param string  $db_name     self-explanatory
 * @param string  $tb_prefix   prefix added to ATutor tables
 * @param string  $comments    "Generated by" comment including PHP comment
 *                             delimeters
 * @param string  $content_dir absolute path to ATutor content directory
 *                             (ignored at runtime if $get_file is false)
 * @param boolean $smtp        whether SMTP should be used for sending mail
 * @param boolean $get_file    whether the protected content directory feature
 *                             should be used
 * @return boolean True if the file is written successfully, false otherwise.
 */
