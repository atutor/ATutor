...
$this->_pages['mods/_standard/student_tools/instructor_index.php']['img']       = 'mods/_standard/student_tools/icon.gif';
$this->_pages['mods/_standard/student_tools/instructor_index.php']['guide']     = 'instructor/?p=fha_student_tools.php';
$this->_pages['mods/_standard/student_tools/instructor_index.php']['avail_in_mobile']   = false;
