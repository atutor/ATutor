...
if($_SESSION['is_admin'] > 0 || authenticate(AT_PRIV_ANNOUNCEMENTS, TRUE) && $_SESSION['hide_admin'] == 0){	
	$this->_pages['mods/_standard/announceents/add_news.php']['title_var']  = 'add_announcement';
	$this->_pages['mods/_standard/announcements/add_news.php']['parent'] = 'index.php';
