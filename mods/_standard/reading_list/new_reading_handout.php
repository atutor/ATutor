...
$rows_resources = queryDB($sql, array(TABLE_PREFIX, $_SESSION['course_id'], RL_TYPE_HANDOUT));
...
<div class="input-form">	
	...
	<div class="row">
		...
		<?php  echo _AT('rl_or'); ?> <a href="mods/_standard/reading_list/add_resource_handout.php"><?php  echo _AT('rl_create_new_handout'); ?></a>
	</div>
