...
"gadgets.iframeBaseUri" : "/shindig/php/gadgets/ifr",

// jsUriTemplate will have %host% and %js% substituted.
// No locked domain special cases, but jsUriTemplate must
// never conflict with a lockedDomainSuffix.
"gadgets.jsUriTemplate" : "http://%host%/shindig/php/gadgets/js/%js%",
...
"gadgets.osDataUri" : "http://%host%/shindig/php/social/rpc",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://%host%/shindig/php/gadgets/proxy?refresh=%refresh%&url=%url%",
    "jsonProxyUrl" : "http://%host%/shindig/php/gadgets/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://localhost/shindig/php/gadgets/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "http://localhost/shindig/php/gadgets/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    }
  },
  "rpc" : {
    ...
    "parentRelayUrl" : "/shindig/php/gadgets/files/container/rpc_relay.html",
  ...
  "opensocial-0.8" : {
    ...
    "path" : "http://%host%/shindig/php/social",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
