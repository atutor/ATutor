...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
	<div class="input-form">
		...
		<div class="row">
			<div class="required" title="<?php echo _AT('required_field'); ?>">*</div><label for="ec_password"><?php echo _AT('ec_password'); ?></label><br/>
		...
		<div class="row">
			...
			<input type="radio" name="ec_email_admin" value="0" id="email0" <?php if (!$_config['ec_email_admin']){ echo 'checked="checked"'; } ?>/><label for="email0"><?php echo _AT('enable'); ?></label>
		</div>
