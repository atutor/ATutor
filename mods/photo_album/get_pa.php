...
/**
 * @desc	This script gets files like get.php, but without the course id as default folder
 * @author	ATutor Authors
 * @copyright	2006, ATRC, University of Toronto
 * @link	http://www.atutor.ca/                                  
 * @license GNU
 */
...
if (defined('AT_FORCE_GET_FILE') && AT_FORCE_GET_FILE) {
	...
	if (($pos = strpos($current_file, '/get_pa.php/')) !== FALSE) {
		$current_file = substr($current_file, $pos + strlen('/get_pa.php/'));
	}
...
$file = AT_CONTENT_DIR . $current_file;
