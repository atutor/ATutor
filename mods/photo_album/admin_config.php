...
/**
 * @desc	This file generates the administrator course moderation config page
...
if (isset($_POST['submit']) && (isset($_POST['radiobutton']))){	//check whether the config moderation request was submitted
...
$template->loadTemplateFile("admin_config.tpl.php");
