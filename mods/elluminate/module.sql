# sql file for Elluminate module

INSERT INTO `language_text` VALUES ('en', '_module', 'elluminate_missing_url', 'You must supply the URL to your Elluminate installation in the field below.', NOW(), '');

INSERT INTO `language_text` VALUES ('en', '_module','elluminate','Elluminate',NOW(),'');
...
INSERT INTO `language_text` VALUES ('en', '_module','elluminate_guest','Login as a guest:',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_FEEDBACK_ELLUMINATEURL_ADD_SAVED','Elluminate configuration options were successfully saved.',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_ERROR_ELLUMINATEURL_ADD_EMPTY','You must enter a URL to the location of your Elluminate installation.',NOW(),'');
