...
$sql = "INSERT INTO ".TABLE_PREFIX."mahara SET member_id=".$_SESSION['member_id']
      .", username='".$registration->username."', password='".$random_password."'";
 ...
 *
 * @param array profilefields    Array of values from registration form. In this case, we don't pass anything
