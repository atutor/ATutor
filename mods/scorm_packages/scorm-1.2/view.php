<?php
/*
 * mods/scorm_packages/scorm-1.2/view.inc.php
 *
...
$me = 'mods/scorm_packages/scorm-1.2/view.php';
...
// check if the org_id belongs to current course
	...
	if ($row["course_id"] <> $_SESSION['course_id'])
	{
		...
		$_pages['mods/scorm_packages/scorm-1.2/view.php']['title_var'] = 'scorm_packages';
