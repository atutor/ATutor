<?php
/*
 * mods/scorm_packages/scorm-1.2/settings.php
 *
...
if (authenticate(AT_PRIV_PACKAGES, AT_PRIV_RETURN)) {
       $_pages['mods/scorm_packages/scorm-1.2/settings.php']['parent'] =
               'mods/scorm_packages/index.php';
       $_pages['mods/scorm_packages/scorm-1.2/settings.php']['children'] = array ();
}
...
if (mysql_num_rows($result) == 0) {
	...
	$_pages['mods/scorm_packages/scorm-1.2/settings.php']['children'] = array();
	$_pages['mods/scorm_packages/scorm-1.2/settings.php']['title']
		= $row['title'];
	$cr = $row['credit'];
	$lm = $row['lesson_mode'];
}
