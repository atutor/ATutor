...
/************************************************************************/
// $Id: menu_pages.php 7575 2008-05-27 18:17:14Z hwong $
...
if (isset($_SESSION['course_id']) && $_SESSION['course_id'] > 0) {
	...
	$_pages['admin/fix_content.php']['parent']    = 'admin/index.php';
        ...
        smal
        09-09-2008
        Add LDAP Auth pages for admin
        */
	
	$_pages['admin/config_ldap.php']['title_var'] = 'config_ldap';
	$_pages['admin/config_ldap.php']['parent']    = 'admin/config_edit.php';
	$_pages['admin/config_edit.php']['children']  = array_merge((array) $_pages['admin/config_edit.php']['children'], array('admin/config_ldap.php'));
	
	$_pages['admin/ldap_auth_log.php']['title_var'] = 'ldap_auth_log';
	$_pages['admin/ldap_auth_log.php']['parent']    = 'admin/config_ldap.php';
	$_pages['admin/config_ldap.php']['children']  = array_merge((array) $_pages['admin/config_ldap.php']['children'], array('admin/ldap_auth_log.php'));
