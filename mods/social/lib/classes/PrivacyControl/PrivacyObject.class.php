...
class PrivacyObject{
	...
	function PrivacyObject(){
		...
		$profile_prefs = array(
								AT_SOCIAL_PROFILE_BASIC			=> array(AT_SOCIAL_EVERYONE_VISIBILITY=>1, AT_SOCIAL_FRIENDS_VISIBILITY=>1),
								AT_SOCIAL_PROFILE_PROFILE		=> array(AT_SOCIAL_EVERYONE_VISIBILITY=>1, AT_SOCIAL_FRIENDS_VISIBILITY=>1),
								AT_SOCIAL_PROFILE_STATUS_UPDATE	=> array(AT_SOCIAL_EVERYONE_VISIBILITY=>1, AT_SOCIAL_FRIENDS_VISIBILITY=>1),
								AT_SOCIAL_PROFILE_MEDIA			=> array(AT_SOCIAL_EVERYONE_VISIBILITY=>1, AT_SOCIAL_FRIENDS_VISIBILITY=>1),
								AT_SOCIAL_PROFILE_CONNECTION	=> array(AT_SOCIAL_EVERYONE_VISIBILITY=>1, AT_SOCIAL_FRIENDS_VISIBILITY=>1),
								AT_SOCIAL_PROFILE_EDUCATION		=> array(AT_SOCIAL_EVERYONE_VISIBILITY=>1, AT_SOCIAL_FRIENDS_VISIBILITY=>1),
								AT_SOCIAL_PROFILE_POSITION		=> array(AT_SOCIAL_EVERYONE_VISIBILITY=>1, AT_SOCIAL_FRIENDS_VISIBILITY=>1)		
							   );
		$search_prefs = array(	
								AT_SOCIAL_SEARCH_VISIBILITY	=> array(AT_SOCIAL_EVERYONE_VISIBILITY=>1, AT_SOCIAL_FRIENDS_VISIBILITY=>1),
