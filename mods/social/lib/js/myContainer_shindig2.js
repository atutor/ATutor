...
"gadgets.iframeBaseUri" : "/shindig2/php/gadgets/ifr",

// jsUriTemplate will have %host% and %js% substituted.
// No locked domain special cases, but jsUriTemplate must
// never conflict with a lockedDomainSuffix.
"gadgets.jsUriTemplate" : "http://%host%/shindig2/php/gadgets/js/%js%",
...
"gadgets.osDataUri" : "http://%host%/shindig2/php/social/rpc",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://%host%/shindig2/php/gadgets/proxy?refresh=%refresh%&url=%url%",
    "jsonProxyUrl" : "http://%host%/shindig2/php/gadgets/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://localhost/shindig2/php/gadgets/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "http://localhost/shindig2/php/gadgets/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    }
  },
  "rpc" : {
    ...
    "parentRelayUrl" : "/shindig2/php/gadgets/files/container/rpc_relay.html",
  ...
  "opensocial-0.8" : {
    ...
    "path" : "http://%host%/shindig2/php/social",
    "domain" : "shindig2",
    "enableCaja" : false,
    "supportedFields" : {
