...
if (isset($_POST['submit_no']))
{
	...
	if ($_POST['permission_granted']==1)
		header('Location: '.AT_BASE_HREF.'admin/modules/module_uninstall_step_3.php?mod='.$_POST['mod'].SEP.'cancelled=1'.SEP.'args='.urlencode($_POST['args']));
	else
	{
...
else if (isset($_POST['submit_yes'], $_POST['mod'])) 
{
	...
	if ($_POST['permission_granted']==1)
	{
		header('Location: '.AT_BASE_HREF.'admin/modules/module_uninstall_step_3.php?uninstalled=1'.SEP.'args='.urlencode($_POST["args"]));
	}
	else
	{
