...
<?php
	if ($row = mysql_fetch_array($result)) {
		do {
			...
			//echo '<td class="row1"><small><a href="users/admin/?remove='.$row['member_id'].'">'._AT('remove').'</a></small></td>';
			echo '<td class="row1"><small><a href="users/admin/admin_deny.php?id='.$row['member_id'].'">'._AT('remove').'</a></small></td>';
			echo '<td class="row1"><small><a href="users/admin/admin_edit.php?id='.$row['member_id'].'">'._AT('approve').'</a></small></td>';
