...
<div class="logoutbar">
	<div id="userlinks">
		...
		<?php $path_parts = explode("/", $this->current_top_level_page); 
		    ...
		    <a href="" class="pref_wiz_launcher"><img alt="<?php echo _AT('preferences').' - '._AT('new_window'); ?>" title="<?php echo _AT('preferences').' - '._AT('new_window'); ?>"  src="<?php echo $this->img; ?>wand.png" class="img1616"/></a> |
		    <?php } ?> 
