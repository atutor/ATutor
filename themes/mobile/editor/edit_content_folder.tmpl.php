...
<?php endif; ?> -->
	<div class="row">
		...
		<input type="text" name="title" id="ftitle" size="40" class="formfield" value="<?php echo ContentManager::cleanOutput($this->ftitle); ?>" />
	</div>
	...
	<table class="data" summary="Title, status, release results, and pass score of available tests">
	<thead>
	<tr>
		<th scope="col">&nbsp;</th>
