...
?>
	...
	<li>
		<div class="forum-post-author">
			<a href="profile.php?id=<?php echo $this->row_messages['to_member_id']; ?>" class="title"><?php echo get_display_name($this->row_messages['to_member_id']); ?></a><br />
			<?php print_profile_img($this->row_messages['to_member_id']); ?>
		</div>
