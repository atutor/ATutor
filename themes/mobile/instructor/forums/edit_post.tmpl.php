...
<div class="input-form">
	<div class="row">
		...
		<input type="text" maxlength="80" name="subject" size="26" value="<?php echo stripslashes(htmlspecialchars($this->subject)); ?>" id="subject" />
	</div>

	<div class="row">
		<span class="required" title="<?php echo _AT('required_field'); ?>">*</span><label for="body"><?php echo _AT('body'); ?></label><br />
		<textarea cols="60" name="body" rows="10" id="body"><?php echo AT_print($this->body, 'text.input'); ?></textarea>
	</div>
