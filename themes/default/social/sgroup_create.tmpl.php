...
<div class="input-form">	
	<form action="<?php echo url_rewrite(AT_SOCIAL_BASENAME.'groups/create.php'); ?>" method="POST" >
		<div class="row">
			...
			<input type="text" size="60" name="group_name" id="group_name" value="<?php echo htmlspecialchars($_POST['group_name'], ENT_QUOTES); ?>"/>
		</div>
		...
		<div class="row">
			...
			<input type="text" size="60" name="logo" id="logo" value="<?php echo htmlspecialchars($_POST['logo'], ENT_QUOTES); ?>"/>
		</div>
