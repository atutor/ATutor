...
<?php
			...
			if ($dict_val == 1) $dict = ' checked="checked" ';
			...
			if ($thes_val == 1) $thes = ' checked="checked" ';
			...
			if ($enc_val == 1) $enc = ' checked="checked" ';
			...
			if ($atla_val == 1) $atla = ' checked="checked" ';
			...
			if ($notes_val == 1) $notes = ' checked="checked" ';
			...
			if ($calc_val == 1) $calc = ' checked="checked" ';
			...
			if ($abac_val == 1) $abac = ' checked="checked" ';
